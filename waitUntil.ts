...
namespace WaitUntilBlocks {
    ...
    //% block.loc.fr="attendre jusqu'à ce que le niveau sonore soit inférieur de %level"
    ...
    //% block.loc.fr="attendre jusqu'à ce que le niveau sonore soit supérieur de %level"
