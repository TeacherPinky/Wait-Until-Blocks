...
namespace WaitUntilBlocks {
    ...
    //% block.loc.fr="attendre jusqu'à ce que le niveau sonore soit de moins de %level"
    ...
    //% block.loc.fr="attendre jusqu'à ce que le niveau sonore soit au-dessus %level"
